...
import { reviewDeposit } from "@/actions/admin-actions";

export default function DepositReviewActions({ transactionId }: { transactionId: string }) {
  ...
  function act(action: "APPROVE" | "REJECT") {
    ...
    startTransition(async () => {
      const result = await reviewDeposit(transactionId, action);
